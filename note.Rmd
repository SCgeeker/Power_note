...
如果我们将相关设定为0.5，则$\sqrt{2(0.5)}=1$。当相关为0.5时，$d=d_Z$。当变量间相关变强时，例如$r=0.9$，我们可以得到$d=d_Z\sqrt{2(1-0.9)}$，当$d_Z$为1时，$d=0.45$。反过来，$d_Z=\frac{d}{\sqrt{2(1-r)}}$，所以当$r=0.9，d=1$时，我们可以得到$d_Z=2.24$。一些观点认为，与d相比，
