...
我们甚至可以在G\*Power中使用SPSS的风格来计算Cohen's f。我们在G*Power中进行如上设定，然后点击'Options'，然后选择'as in SPSS'，然后点击OK，你会看到'Corr among rep measures'部分不见了。相关不需要单独输入，但是在Cohen's f之中。Cohen's f的原值为0.25，现为0.7024394。这与SPSS相同。这个值更大，并且与偏eta方相对应且包含了观测值之间的相关。
